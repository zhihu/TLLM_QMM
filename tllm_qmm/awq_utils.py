# adapted and modified from: https://github.com/casper-hansen/AutoAWQ/blob/main/awq/utils/packing_utils.py
# Copyright (c) 2024 Zhihu Inc.
...
def pack_columnwise(izeros: torch.Tensor, bits: int):
